...
public class HatchMechS extends Subsystem {
  ...
  public HatchMechS(){
    ...
    hatchMechanism = new DoubleSolenoid(RobotMap.PCM_ID_DSOLENOID_HATCHMECH, RobotMap.DSOLENOID_HATCHMECH_FORWARD_CHANNEL, RobotMap.DSOLENOID_HATCHMECH_REVERSE_CHANNEL);
  }
