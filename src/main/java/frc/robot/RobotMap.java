...
public class RobotMap {
  ...
  public static final double[] DRIVE_LEFT_VELOCITY_PID = {1.0, 0.0, 0.0};
  public static final double[] DRIVE_RIGHT_VELOCITY_PID = {1.0, 0.0, 0.0};
  public static final double[] DRIVE_TURN_PID = {-.5, 0.0, 0.0};
}
