...
public class OI {
    ...
    public OI() {
        ...
        buttonBoard.thumb_runWhileHeld(new LadderSetLevelC(LadderLevel.LEVEL_ONE));
        buttonBoard.index_runWhileHeld(new LadderSetLevelC(LadderLevel.LEVEL_TWO));
        buttonBoard.middle_runWhileHeld(new LadderSetLevelC(LadderLevel.LEVEL_THREE));
