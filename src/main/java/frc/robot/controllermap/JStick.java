...
public class JStick {
    ...
    private JoystickButton one_trigger;
    private JoystickButton two_thumb;
    private JoystickButton three_topBottomLeft;
    private JoystickButton four_topBottomRight;
    private JoystickButton five_topTopLeft;
    private JoystickButton six_topTopRight;
    private JoystickButton seven_leftTopLeft;
    private JoystickButton eight_leftTopRight;
    private JoystickButton nine_leftMiddleLeft;
    private JoystickButton ten_leftMiddleRight;
    private JoystickButton eleven_leftBottomLeft;
    private JoystickButton twelve_leftBottomRIght;

    private POVButton hat_up;
    private POVButton hat_down;
    private POVButton hat_left;
    private POVButton hat_right;
    private POVButton hat_up_left;
    private POVButton hat_up_right;
    private POVButton hat_down_left;
    private POVButton hat_down_right;
    private POVButton hat_center;

    private enum POV {
        UP, DOWN, LEFT, RIGHT, UP_RIGHT, UP_LEFT, DOWN_LEFT, DOWN_RIGHT, CENTER;
    }

    private int HAT(POV pov) {
        switch (pov) {
        case UP:
            return 0;
        case UP_RIGHT:
    ...
    private final int BUTTON_7 = 7;
    private final int BUTTON_8 = 8;
    private final int BUTTON_9 = 9;
    private final int BUTTON_10 = 10;
    ...
    private final int AXIS_THROT = 3;

    private final int HAT_UP = HAT(POV.UP);
    private final int HAT_DOWN = HAT(POV.DOWN);
    private final int HAT_LEFT = HAT(POV.LEFT);
    private final int HAT_RIGHT = HAT(POV.RIGHT);
    private final int HAT_UP_LEFT = HAT(POV.UP_LEFT);
    private final int HAT_UP_RIGHT = HAT(POV.UP_RIGHT);
    private final int HAT_DOWN_LEFT = HAT(POV.DOWN_LEFT);
    private final int HAT_DOWN_RIGHT = HAT(POV.DOWN_RIGHT);
    private final int HAT_CENTER = HAT(POV.CENTER);
